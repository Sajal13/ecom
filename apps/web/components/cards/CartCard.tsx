...
const CartCard = ({ product }: CartCardProps) => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-10 px-4 lg:px-10 py-6 shadow-lg mb-10 last:mb-0">
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-5 group relative">
          ...
          <div
            id="tooltip-light"
            role="tooltip"
            className="absolute hidden bottom-full z-20 text-nowrap sm:inline-block px-3 py-2 text-sm font-medium  bg-neutral-200 rounded-md shadow-xs transition-all duration-200 opacity-0 group-hover:opacity-100"
          >
            {product.title}
          </div>
        </div>
